                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-3 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                                    <label for="password_2">ID WARGA</label>
                                                </div>
                                                <div class="col-lg-6 col-md-10 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="text" id="nirm" name="nirm" class="form-control" placeholder="Inputkan ID Warga" onkeypress="return validKey(event || window.event, '0123456789');"required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

                ...
                <div class="col-md-6">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <input type="radio" name="semester" value="awal" id="male" class="with-gap">
                                <label for="male">Awal</label>

                                <input type="radio" name="semester" value="akhir" id="female" class="with-gap">
                                <label for="female" class="m-l-20">Akhir</label>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">

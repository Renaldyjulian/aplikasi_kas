...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <body>
        ...
        <div id="isi">
            ...
            ?>
            <div id="identitas">
                <i><b style="font-size: 20px;">Pembayaran   <?php echo ucwords($data['keterangan_spp']) ?> Tahun   <?php echo $data['tahun_ajaran']," - ", ucwords($data['semester']) ?>  sebesar <?php echo 'Rp. ',number_format($data['total'],0,',','.')?></b></i> 
            </div>
            <?php
                    }
                }else{
            ?>
            <div id="identitas">
                <i><b style="font-size: 20px;">Pembayaran   <?php echo ucwords($data['keterangan_spp']) ?> Tahun   <?php echo $data['tahun_ajaran']," - ", ucwords($data['semester']) ?>  sebesar <?php echo 'Rp. ',number_format($data['jumlah_bayar'],0,',','.')?></b></i> 
            </div>
            <?php
                }
            ?>
            ...
            <div id="footer-jabatan2">
                BENDAHARA PERUMAHAN KHIFAYATUL AKHYAR
            </div>

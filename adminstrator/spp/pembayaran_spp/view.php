...
<section class="content">
    <div class="container-fluid">   
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="nim" class="form-control" placeholder="Input Nik" required>
                                            </div>
                                            <i><b>* Masukan Nik Untuk Melakukan Pembayaran KAS</b></i>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <i><b>*Pembayaran KAS Hanya Bisa Dilakukan 6 Kali Pencicilan</b></i>
                        </div>
                    </div>
                </div>
                <!-- #END# Task Info -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>History Angsuran Pembayaran</h2>
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <a href="javascript:void(0);" data-toggle="cardloading" data-loading-effect="ios">
                                        <i class="material-icons">loop</i>

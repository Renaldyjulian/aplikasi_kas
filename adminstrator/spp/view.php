                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="active"><a href="#tagihan" data-toggle="tab"> <i class="material-icons">create</i>  Tagihan KAS</a></li>
                                <li role="presentation"><a href="#tahun_ajaran" data-toggle="tab"> <i class="material-icons">create</i>  Tahun</a></li>
                                <li role="presentation" ><a href="#spp" data-toggle="tab"> <i class="material-icons">create</i> KAS</a></li>

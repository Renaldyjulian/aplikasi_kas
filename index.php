...
<body class="login-page">
    <div class="login-box">
        <div class="logo" style="text-align: center; color: white;">
            <img src="images/puri.jpg" width="120" height="120" style="width: 100px;height: 100px;border-radius: 20%; border-image: 20px; border-color: black;">
            <h4> SISTEM INFORMASI PEMBAYARAN KAS<br> <?php echo strtoupper($tampil['nama_universitas'])?></h4>

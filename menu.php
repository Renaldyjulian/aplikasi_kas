...
<body class="theme-deep-purple">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">SISTEM INFORMASI PEMBAYARAN KAS </a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            ?>
                            <li>
                                <a href="?page=spp_aktif">Aktifkan KAS</a>
                            </li>
                            <?php 
                                } 
                            ?>
                            <li>
                                <a href="?page=spp_data">Data KAS</a>
                            </li>
                            <li>
                                <a href="?page=spp_pembayaran">Pembayaran KAS</a>
                            </li>
                        </ul>
                    </li>
                    <?php
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2021 <a href="javascript:void(0);">Pembayaran KAS - PURI SENTOSA Pekanbaru</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
